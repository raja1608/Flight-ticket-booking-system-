...
public class ImportFeedbackForm extends javax.swing.JFrame {
     ...
     */
    public ImportFeedbackForm(ImportResult importResult) {
         initComponents();
         lblTotalRows.setText(String.valueOf(importResult.getTotalRows()));
         lblImportedRows.setText(String.valueOf(importResult.getImportedRows()));
         lblFailedRows.setText(String.valueOf(importResult.getFailedRows()));
    }
